				...
				<ul>
					<?php if(is_array($info_qiang)): foreach($info_qiang as $key=>$v): ?><li>
						<dl>
							...
							<dd><a href="<?php echo U('Goods/detail',array('goods_id'=>$v['goods_id']));?>" target='_blank'><?php echo ($v["goods_name"]); ?></a></dd>
...
<div class="floor1 floor w1210 bc mt10">
	...
	<div class="sidebar fl ml10">
		...
		<!-- 分类资讯 start -->
		<div class="info mt10">
			<h2><strong>最近登录系统的前5个用户</strong></h2>
			<div class="sidebar_wrap">
				<ul>
					<?php if(is_array($recent_user)): foreach($recent_user as $key=>$v): ?><li><a href=""><b>.</b><?php echo ($v); ?></a></li><?php endforeach; endif; ?>
				</ul>
			</div>
		</div>
		<!-- 分类资讯 end -->
