...
<div class="list w1210 bc mt10">
		...
		<div class="filter mt10">
			...
			<div class="filter_wrap">
				...
				<?php if(empty($_GET['price'])): ?><dl>
					<dt>价格：</dt>
					<dd class="cur"><a href="">不限</a></dd>
					<?php if(is_array($string_price)): foreach($string_price as $key=>$v): ?><dd><a href="/index.php/Home/<?php echo ($_SERVER['PATH_INFO']); ?>/price/<?php echo ($v); ?>"><?php echo ($v); ?></a></dd><?php endforeach; endif; ?>
				</dl><?php endif; ?>
 ...
 $attrcdt = I('get.'); $attr_exists = array(); foreach($attrcdt as $k => $v){ if( strpos($k,'attr_') === 0){ $a = explode('_',$k); $attr_exists[] = $a[1]; } } ?>
				<?php if(is_array($attrinfoT)): foreach($attrinfoT as $key=>$v): if(!in_array(($v["attr_id"]), is_array($attr_exists)?$attr_exists:explode(',',$attr_exists))): ?><dl>
					...
					<dd class="cur"><a href="">不限</a></dd>
					<?php if(is_array($v["attr_value"])): foreach($v["attr_value"] as $key=>$vv): ?><dd><a href="/index.php/Home/<?php echo ($_SERVER['PATH_INFO']); ?>/attr_<?php echo ($v["attr_id"]); ?>/<?php echo ($vv); ?>"><?php echo ($vv); ?></a></dd><?php endforeach; endif; ?>
				</dl><?php endif; endforeach; endif; ?>
			</div>
		</div>
		<!-- 商品筛选 end -->
 ...
 $pai = I('get.pai','xl'); if(I('get.pai')==='goods_shop_price'){ $xu = I('get.xu'); } if(I('get.pai')==='add_time'){ $xu = I('get.xu'); } ?>
		...
		<div class="sort mt10">
			<dl>
				<dt>排序：</dt>
				<dd <?php if(($pai) == "xl"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo ($_SERVER['PATH_INFO']); ?>/pai/xl">销量</a></dd>

				<!--价格升降，点击的时候要去除pai和xu的get参数-->
				<?php if($xu==='asc' && $pai=='goods_shop_price'){ ?>
				<dd <?php if(($pai) == "goods_shop_price"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/goods_shop_price/xu/desc">价格【降】</a></dd>
				<?php }else if($xu==='desc' && $pai=='goods_shop_price'){ ?>
				<dd <?php if(($pai) == "goods_shop_price"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/goods_shop_price/xu/asc">价格【升】</a></dd>
				<?php }else{ ?>
				<dd><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/goods_shop_price/xu/desc">价格</a></dd>
				<?php } ?>


				<dd <?php if(($pai) == "pl"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/pl">评论数</a></dd>


				<?php if($xu==='asc' && $pai=='add_time'){ ?>
				<dd <?php if(($pai) == "add_time"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/add_time/xu/desc">上架时间【降】</a></dd>
				<?php }else if($xu==='desc' && $pai=='add_time'){ ?>
				<dd <?php if(($pai) == "add_time"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/add_time/xu/asc">上架时间【升】</a></dd>
				<?php }else{ ?>
				<dd <?php if(($pai) == "add_time"): ?>class="cur"<?php endif; ?>><a href="/index.php/Home/<?php echo unsetUrlParams('pai,xu');?>/pai/add_time/xu/desc">上架时间</a></dd>
				<?php } ?>
			</dl>
		</div>
		<!-- 排序 end -->
