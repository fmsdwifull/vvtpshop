...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="/vvtpshop/index.php/Home/User/regist.html" method="post">
                <ul><li><label for="">用户名：</label>
...
<li class="checkcode">
    <label for="">验证码：</label>
    <input type="text" id='verify_code' name="verify_code" maxlength='4'
     onkeyup='check_code()'/>
    <img src="<?php echo U('verifyImg');?>"  alt="验证码" onclick="this.src='/vvtpshop/index.php/Home/User/verifyImg/'+Math.random()" />
