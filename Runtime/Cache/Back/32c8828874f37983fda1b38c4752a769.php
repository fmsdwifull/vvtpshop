...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/vvtpshop/index.php/Back/Admin/login" method="post">
                        <ul>
    ...
    <li class="user_main_input">
        ...
        <img src="<?php echo U('verifyImg');?>"  alt="验证码" onclick="this.src='/vvtpshop/index.php/Back/Admin/verifyImg/'+Math.random()" />
