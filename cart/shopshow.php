                    ...
                    <table cellpadding="5" cellspacing="1">
                        <tbody>
                            ...
                            <?php 
                                ...
                                foreach($cart_info as $_k => $_v){ 
                            ?>
                            <tr id="product<?php echo $_v['product_id']; ?>">
                                <td><?php echo $i++; ?></td>
                                <td align="center">
                                    <?php echo $_v['product_name']; ?>
                                </td>
                                <td align="right">￥<?php echo $_v['product_price']; ?>元</td>
                                <td align="right">￥<?php echo $_v['product_price']; ?>元</td>
                                <td align="right">

                            <img src="./images/bag_close.gif" width="9" height="9" onclick="change_reduce(<?php echo $_v['product_id']; ?>)" class="number_change"/>
                            <input name="product_buy_number" type="text" class="num" id="product_buy_number<?php echo $_v['product_id']; ?>" value="<?php echo $_v['product_buy_number'] ?>" size="8" onchange="change_number(<?php echo $_v['product_id']; ?>)"/>
                            <img src="./images/bag_open.gif" width="9" height="9" onclick="change_add(<?php echo $_v['product_id']; ?>)" class="number_change"/>


                                </td>
                                <td align="right">￥<span id="product_total_price<?php echo $_v['product_id']; ?>"><?php echo $_v['product_total_price']; ?></span>元</td>
                                <td align="center">
                                    <a href="javascript:;" class="f6"  onclick="cart_del(<?php echo $_v['product_id']; ?>)">删除</a>
                                </td>
                            </tr>
                            <?php } }?>
                        </tbody></table>
