...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="./images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue" />
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="clearfix">
                                <li class="goodsimg">
                                    <a href="#" target="_blank">
                                        <img src="./images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue" />
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="box_1">
                        <h3>
                            ...
                            <form method="GET" class="sort" name="listform">
                                显示方式：
                                <a href="#"><img src="./images/display_mode_list.gif" alt=""></a>
                                <a href="#"><img src="./images/display_mode_grid_act.gif" alt=""></a>
                                <a href="#"><img src="./images/display_mode_text.gif" alt=""></a>&nbsp;&nbsp;

                                <a href="#"><img src="./images/goods_id_DESC.gif" alt="按上架时间排序"></a>
                                <a href="#"><img src="./images/shop_price_default.gif" alt="按价格排序"></a>
                                <a href="#"><img src="./images/last_update_default.gif" alt="按更新时间排序"></a>
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/32_thumb_G_1242110760196.jpg" alt="诺基亚N85" class="goodsimg" id="markimg31"></a><br />
                                    <p><a href="#" title="诺基亚N85">诺基亚N85</a></p>
                                    <font class="market_s">￥3612元</font><br />
                                    <font class="shop_s">￥3010元</font><br />
                                    <input type="button" onclick="cart_add(31,'诺基亚N85',3010)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/24_thumb_G_1241971981429.jpg" alt="P806" class="goodsimg" id="markimg32"></a><br />
                                    <p><a href="#" title="P806">P806</a></p>
                                    <font class="market_s">￥2400元</font><br />
                                    <font class="shop_s">￥2000元</font><br />
                                    <input type="button" onclick="cart_add(32,'P806',2000)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/22_thumb_G_1241971076803.jpg" alt="多普达Touc..." class="goodsimg" id="markimg33"></a><br />
                                    <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p>
                                    <font class="market_s">￥7199元</font><br />
                                    <font class="shop_s">￥5999元</font><br />
                                    <input type="button" onclick="cart_add(33,'多普达',5999)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/21_thumb_G_1242109298150.jpg" alt="金立 A30" class="goodsimg" id="markimg34"></a><br />
                                    <p><a href="#" title="金立 A30">金立 A30</a></p>
                                    <font class="market_s">￥2400元</font><br />
                                    <font class="shop_s">￥2000元</font><br />
                                    <input type="button" onclick="cart_add(34,'金立A30',2000)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/20_thumb_G_1242106490058.jpg" alt="三星BC01" class="goodsimg" id="markimg35"></a><br />
                                    <p><a href="#" title="三星BC01">三星BC01</a></p>
                                    <font class="market_s">￥336元</font><br />
                                    <font class="shop_s">￥280元</font><br />
                                    <input type="button" onclick="cart_add(35,'三星BC01',280)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/19_thumb_G_1241970175208.jpg" alt="三星SGH-F..." class="goodsimg" id="markimg36"></a><br />
                                    <p><a href="#" title="三星SGH-F258">三星SGH-F...</a></p>
                                    <font class="market_s">￥1030元</font><br />
                                    <font class="shop_s">￥858元</font><br />
                                    <input type="button" onclick="cart_add(36,'三星SGH-F',858)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                                <div class="goodsItem">
                                    <a href="#"><img src="./images/17_thumb_G_1241969394587.jpg" alt="夏新N7" class="goodsimg" id="markimg37"></a><br />
                                    <p><a href="#" title="夏新N7">夏新N7</a></p>
                                    <font class="market_s">￥2760元</font><br />
                                    <font class="shop_s">￥2300元</font><br />
                                    <input type="button" onclick="cart_add(37,'夏新N7',2300)" value="购 买" class="btn_01" />
                                    <input type="submit" value="收 藏" class="btn_01" />
                                </div>
                            </div>
                        </form>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="./images/category.htm" alt="YONGDA商城" border="0"></a>
        ...
        <div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
            <h4>
                <span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="./images/close.jpg" title="点击关闭"/></a></span>
                该商品已成功添加到购物车
            </h4>
            <p style="padding-left:60px;">
                购物车共计 <span class="orange"><strong id="goods_number"><!--{$number_price.number}--></strong></span> 个商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                合计：<span class="orange"><strong id="goods_totalprice"><!--{$number_price.price}--></strong></span> 元
            </p>
            <p>
                <a href="./shopshow.php" onclick="javascript:hideElement('cartBox')" class="bt_orange" target="_black"></a>
