...
class Cart{
    ...
    */
    function add($goods){
        ...
        if(!empty($this->cartInfo) && array_key_exists($pd_id, $this->cartInfo)){
            //1数量增加
            $this->cartInfo[$pd_id]['goods_number'] +=1;
            //2单间商品的总价增加 单间商品总价=单价*数量
            $this->cartInfo[$pd_id]['goods_total_price'] = $this->cartInfo[$pd_id]['goods_price']*$this->cartInfo[$pd_id]['goods_number'];
        } else {
    ...
    */
    function changeNumber($pd_number,$pd_id){
        ...
        //1修改商品的数量
        $this->cartInfo[$pd_id]['goods_number'] = $pd_number;
        //2修改单件商品的小计价格
...
//var_dump($this->cartInfo);
    ...
    */
    function saveData(){
        ...
        //setcookie的第4个参数‘/’，表示设置的cookie在“任何目录”都可以访问
        //脚本： http://网址/1/2/3/4.php  设置cookie  /
        //脚本： http://网址/1
        //脚本： http://网址/1/2
        //脚本： http://网址/a/b/c.php 设置cookie  ./
        //脚本： http://网址/a
    }
}